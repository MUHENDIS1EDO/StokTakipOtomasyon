...
namespace StokTakipOtomasyon {
    ...
    public partial class StokTakipOtomasyonuDataSet2 : global::System.Data.DataSet {
        ...
        public partial class tbl_UsersDataTable : global::System.Data.TypedTableBase<tbl_UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_UsersRow Addtbl_UsersRow(string Name, string LastName, string UserType, string Email, string Password, string Gender) {
...
namespace StokTakipOtomasyon.StokTakipOtomasyonuDataSet2TableAdapters {
    ...
    public partial class tbl_UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_Users] WHERE (([UserId] = @Original_UserId) AND ([Name] = @Original_Name) AND ([LastName] = @Original_LastName) AND ([UserType] = @Original_UserType) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Gender] = @Original_Gender))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_Users] ([Name], [LastName], [UserType], [Email], [Password], [Gender]) VALUES (@Name, @LastName, @UserType, @Email, @Password, @Gender);
SELECT UserId, Name, LastName, UserType, Email, Password, Gender FROM tbl_Users WHERE (UserId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_Users] SET [Name] = @Name, [LastName] = @LastName, [UserType] = @UserType, [Email] = @Email, [Password] = @Password, [Gender] = @Gender WHERE (([UserId] = @Original_UserId) AND ([Name] = @Original_Name) AND ([LastName] = @Original_LastName) AND ([UserType] = @Original_UserType) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Gender] = @Original_Gender));
SELECT UserId, Name, LastName, UserType, Email, Password, Gender FROM tbl_Users WHERE (UserId = @UserId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, Name, LastName, UserType, Email, Password, Gender FROM dbo.tbl_Use" +
                "rs";
        ...
        public virtual int Fill(StokTakipOtomasyonuDataSet2.tbl_UsersDataTable dataTable) {
        ...
        public virtual StokTakipOtomasyonuDataSet2.tbl_UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StokTakipOtomasyonuDataSet2.tbl_UsersDataTable dataTable = new StokTakipOtomasyonuDataSet2.tbl_UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StokTakipOtomasyonuDataSet2.tbl_UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserId, string Original_Name, string Original_LastName, string Original_UserType, string Original_Email, string Original_Password, string Original_Gender) {
        ...
        public virtual int Insert(string Name, string LastName, string UserType, string Email, string Password, string Gender) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string LastName, string UserType, string Email, string Password, string Gender, int Original_UserId, string Original_Name, string Original_LastName, string Original_UserType, string Original_Email, string Original_Password, string Original_Gender, int UserId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string LastName, string UserType, string Email, string Password, string Gender, int Original_UserId, string Original_Name, string Original_LastName, string Original_UserType, string Original_Email, string Original_Password, string Original_Gender) {
            return this.Update(Name, LastName, UserType, Email, Password, Gender, Original_UserId, Original_Name, Original_LastName, Original_UserType, Original_Email, Original_Password, Original_Gender, Original_UserId);
        }
    }
